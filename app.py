...
def textanalysis():
    ...
    if 'transcript' in session:
        if request.method == 'POST':
            ...
            send_email(f"{subject} - Your Lecture", session['transcript'], reciever,
                       'hackathon2020', 'madcuzbad211@gmail.com', session['videos'], session['keywords'])
...
def contactform():
    ...
    if email == "" or subject == "" or msg == "":
        ...
        email.send_email(subject, msg, 'madcuzbad211@gmail.com',
                         'hackathon2020', 'madcuzbad211@gmail.com')
